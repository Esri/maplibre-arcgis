/* @esri/maplibre-arcgis - v1.2.0 - Mon Mar 09 2026 15:02:58 GMT-0700 (Pacific Daylight Time)
...
var FeatureLayerSourceManager = class {
  ...
  _updateSourceData(map, fc) {
    const source = map.getSource(this.geojsonSourceId);
    if (source) {
      source.setData(fc);
      return;
    }
