...
export declare const checkItemId: (itemId: string) => boolean;
export declare const getServiceType: (serviceUrl: string) => ServiceType | null;
...
export declare const wrapAccessToken: (token?: string, portalUrl?: string) => Promise<ApiKeyManager | ArcGISIdentityManager | undefined>;
