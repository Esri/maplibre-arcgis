/* @esri/maplibre-arcgis - v1.1.0 - Fri Dec 26 2025 14:09:33 GMT-0600 (Central Standard Time)
...
var FeatureLayer = class _FeatureLayer extends HostedLayer {
  ...
  async _fetchAllFeatures(layerUrl, layerInfo) {
    ...
    if (layerInfo.supportsExceedsLimitStatistics) {
      ...
      let queryParams, ignoreFeatureLimit;
      if (this.query) {
        ...
        outStatistics: [
          {
            ...
            // This is required by REST JS but not used
      ...
      if (exceedsLimitResponse.features[0].attributes.exceedslimit === 0 || ignoreFeatureLimit) {
        if (ignoreFeatureLimit) warn2(`Feature count limits are being ignored from ${layerUrl}. This is recommended only for low volume layers and applications and will cause poor server performance and crashes.`);
...
var package_default = {
  ...
  dependencies: {
    "@esri/arcgis-rest-basemap-sessions": "^1.1.0",
    "@esri/arcgis-rest-feature-service": "^4.3.0",
