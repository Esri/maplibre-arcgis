/* @esri/maplibre-arcgis - v1.0.0-beta-6 - Wed Sep 10 2025 17:03:31 GMT-0700 (Pacific Daylight Time)
...
var HostedLayer = class {
  ...
  get token() {
    if (!this.authentication) return void 0;
...
var FeatureLayer = class _FeatureLayer extends HostedLayer {
  ...
  constructor(options) {
    ...
    if (this._inputType == "ItemId") {
      ...
      warn2("The provided service URL does not point to any specific feature layer. Layer '/0' will be loaded from the service automatically.");
      this._serviceInfo = {
        serviceUrl: `${cleanUrl2(options.url)}0`
      };
